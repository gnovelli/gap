...
plot 'USERS_FT_MEAN.dat' using 3:xticlabels(1) linecolor rgb "red" title "Response Time", \
      'USERS_RT_MEAN.dat' using 3:xticlabels(1) linecolor rgb "blue" title "First Chunk Time"
set xlabel "Attached to router"
set ylabel "Normalized Streaming Time"
set boxwidth 1.0 relative
set style histogram clustered gap 2
